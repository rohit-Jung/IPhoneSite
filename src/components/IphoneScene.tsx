...
Command: npx gltfjsx@6.2.16 --types C:\Users\Admin\Documents\--CODING--\iphone-clone\public\models\scene.glb 
...
type Props = {
  scale: THREE.Vector3;
  item?: JSX.ElementType | any;
  size?: string;
};

export function IphoneScene(props: Props) {
  const { nodes, materials } = useGLTF("/models/scene.glb") as GLTFResult;

  const texture = useTexture<THREE.Texture | any>(props.item?.img);
